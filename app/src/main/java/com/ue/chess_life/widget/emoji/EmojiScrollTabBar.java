...
public class EmojiScrollTabBar extends RelativeLayout{
    ...
    public EmojiScrollTabBar(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(R.layout.view_emojicon_tab_bar, this);
    ...
    public void addTab(int icon){
        View tabView = View.inflate(context, R.layout.item_scroll_tab, null);
    ...
    public void selectedTo(int position){
        ...
        for (int i = 0; i < tabList.size(); i++) {
            if (position == i) {
                tabList.get(i).setBackgroundColor(getResources().getColor(R.color.col_d9d9d9));
            } else {
