...
import com.ue.chess_life.entity.EaseEmoji.Type;
import com.ue.chess_life.entity.EaseEmojiGroup;
import com.ue.chess_life.feature.game.emoji.EmojiGridAdapter;
import com.ue.chess_life.feature.game.emoji.EmojiPagerAdapter;
import com.ue.chess_life.util.EaseSmileUtils;

import java.util.ArrayList;
import java.util.List;

public class EmojiPagerView extends ViewPager{

    private Context context;
    private List<EaseEmojiGroup> groupEntities;
    ...
    public void init(List<EaseEmojiGroup> emojiconGroupList, int emijiconColumns, int bigEmojiconColumns){
        ...
        for(int i = 0; i < groupEntities.size(); i++){
            EaseEmojiGroup group = groupEntities.get(i);
            List<EaseEmoji> groupEmojicons = group.getEmojiconList();
     ...
     * @return
     */
    public List<View> getGroupGridViews(EaseEmojiGroup groupEntity){
        List<EaseEmoji> emojiconList = groupEntity.getEmojiconList();
        ...
        for(int i = 0; i < pageSize; i++){
            View view = View.inflate(context, R.layout.layout_expressions, null);
            ...
            List<EaseEmoji> list = new ArrayList<EaseEmoji>();
            if(i != pageSize -1){
            ...
            if(emojiType != Type.BIG_EXPRESSION){
                EaseEmoji deleteIcon = new EaseEmoji();
            ...
            gv.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    EaseEmoji emojicon = gridAdapter.getItem(position);
                    if(pagerViewListener != null){
     ...
     * @param groupEntity
     */
    public void addEmojiconGroup(EaseEmojiGroup groupEntity, boolean notifyDataChange) {
     ...
     * @return
     */
    private int getPageSize(EaseEmojiGroup groupEntity) {
        List<EaseEmoji> emojiconList = groupEntity.getEmojiconList();
        int itemSize = emojiconColumns * emojiconRows -1;
        int totalSize = emojiconList.size();
        Type emojiType = groupEntity.getType();
