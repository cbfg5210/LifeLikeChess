...
public class EmojiIndicatorView extends LinearLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_dot_emojicon_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.mipmap.ic_dot_emojicon_unselected);
