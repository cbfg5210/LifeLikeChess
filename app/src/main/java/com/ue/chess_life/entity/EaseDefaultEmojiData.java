...
public class EaseDefaultEmojiData {
...
//        R.mipmap.ee_35,
    ...
    private static final EaseEmoji[] DATA = createData();
    
    private static EaseEmoji[] createData(){
        EaseEmoji[] datas = new EaseEmoji[icons.length];
        for(int i = 0; i < icons.length; i++){
            datas[i] = new EaseEmoji(icons[i], emojis[i], EaseEmoji.Type.NORMAL);
        }
        return datas;
    }
    
    public static EaseEmoji[] getData(){
        return DATA;
    }
}
